...
const CreateTemplate = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      console.log("Template created successfully", templateRes.data);
    } catch (error) {
...
// try {
//   // Frontend-এ সমস্ত ফিল্ড যোগ করুন
//   const postData = {
//     title: data.title,
//     description: data.description,
//     topic: data.topic,
//     tags: data.tags,
//     imageUrl: data.image || null, // Optional হলে null পাঠান
//     accessType: data.accessType || "PUBLIC", // Default value
//   };
//   console.log(postData);

//   const res = await axiosPublic.post("/templates", postData);
//   console.log("✅ Tags posted", res.data);
// } catch (error) {
